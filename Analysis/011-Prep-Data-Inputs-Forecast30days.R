...
# Project tests available into future
...
tests_fx <- approxfun(c(sf_test_smooth$date_num, 
...
saveRDS(data_inputs, here::here("data", "processed", "data_inputs_forecast30days.rds"))
