...
input_pars$test_pars$hpi_mult              <- best_pars[14]
input_pars$test_pars$income_mult           <- best_pars[15]
input_pars$test_pars$case_finding_mult     <- best_pars[16]
input_pars$test_pars$cont_mult             <- best_pars[17]
input_pars$test_pars$symp_mult             <- best_pars[18]
input_pars$test_pars$res_mult              <- best_pars[19]
input_pars$test_pars$symp_state_mult       <- best_pars[20]
